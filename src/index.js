...
// Resolve Spotify URLs to YouTube search queries
async function resolveSpotifyUrl(spotifyUrl) {
  try {
    ...
    if (!match) {
      console.log(`[Spotify] Invalid Spotify URL format`);
      return null;
    }

    const spotifyType = match[1];
    console.log(`[Spotify] Detected type: ${spotifyType}`);

    // Use play-dl to get track info
    // play.spotify() returns different structures based on type
    let searchQuery = '';
    ...
    if (!searchQuery) {
      console.log(`[Spotify] Could not generate search query from play-dl response`);
      return null;
    }
  ...
  setImmediate(() => {
    ...
    function initializeRainlink(libraryConnector) {
      ...
      rainlink.on('nodeDisconnect', (node, reason) => {
        ...
        2025-11-01T23:22:58.604Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/loadtracks?identifier=ytsearch%3A%21p+https%3A%2F%2Fopen.spotify.com%2Ftrack%2F6GBBnbNFzAqwowHOjHQysr%3Fsi%3D4ee42ff94b1f45a7
        2025-11-01T23:23:50.438Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Sent {"op":"stats","frameStats":null,"players":1,"playingPlayers":0,"uptime":167368,"memory":{"free":224568248,"used":60644424,"allocated":285212672,"reservable":32178700288},"cpu":{"cores":48,"systemLoad":0.3417689955984707,"lavalinkLoad":0.001317859294464154}}
        2025-11-01T23:23:54.272Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/stats
        2025-11-01T23:23:54.337Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.player.AudioLoaderRestHandler   : Got request to load for identifier "https://open.spotify.com/track/6GBBnbNFzAqwowHOjHQysr?si=4ee42ff94b1f45a7"
        2025-11-01T23:23:54.537Z ERROR 1 --- [Lavalink] [  XNIO-1 task-2] l.server.player.AudioLoaderRestHandler   : Failed to load track for identifier https://open.spotify.com/track/6GBBnbNFzAqwowHOjHQysr?si=4ee42ff94b1f45a7
        ...
        Caused by: com.sedmelluq.discord.lavaplayer.tools.FriendlyException: Unknown file format.
          at com.sedmelluq.discord.lavaplayer.source.ProbingAudioSourceManager.handleLoadResult(ProbingAudioSourceManager.java:35) ~[lavaplayer-2.2.3.jar!/:na]
          at com.sedmelluq.discord.lavaplayer.source.http.HttpAudioSourceManager.loadItem(HttpAudioSourceManager.java:73) ~[lavaplayer-2.2.3.jar!/:na]
          at com.sedmelluq.discord.lavaplayer.player.DefaultAudioPlayerManager.checkSourcesForItemOnce(DefaultAudioPlayerManager.java:442) ~[lavaplayer-2.2.3.jar!/:na]
          at com.sedmelluq.discord.lavaplayer.player.DefaultAudioPlayerManager.checkSourcesForItem(DefaultAudioPlayerManager.java:423) ~[lavaplayer-2.2.3.jar!/:na]
          at com.sedmelluq.discord.lavaplayer.player.DefaultAudioPlayerManager.loadItemSync(DefaultAudioPlayerManager.java:154) ~[lavaplayer-2.2.3.jar!/:na]
          at com.sedmelluq.discord.lavaplayer.player.AudioPlayerManager.loadItemSync(AudioPlayerManager.java:127) ~[lavaplayer-2.2.3.jar!/:na]
          at lavalink.server.util.LoadingKt.loadAudioItem(loading.kt:15) ~[classes!/:4.1.1]
          ... 67 common frames omitted
        2025-11-01T23:23:54.541Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/loadtracks?identifier=https%3A%2F%2Fopen.spotify.com%2Ftrack%2F6GBBnbNFzAqwowHOjHQysr%3Fsi%3D4ee42ff94b1f45a7
        2025-11-01T23:24:08.033Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Sent {"op":"event","type":"WebSocketClosedEvent","guildId":"1257685068927733902","code":4014,"reason":"Disconnected.","byRemote":true}
        2025-11-01T23:24:08.033Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Sent {"op":"playerUpdate","state":{"time":1762039448032,"position":0,"connected":false,"ping":22},"guildId":"1257685068927733902"}
        2025-11-01T23:24:08.122Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : DELETE /v4/sessions/5blxuy3b6m7u23n8/players/1257685068927733902
        2025-11-01T23:24:25.487Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/stats
        2025-11-01T23:24:25.647Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : PATCH /v4/sessions/5blxuy3b6m7u23n8/players/1257685068927733902?noReplace=false, payload={"voice":{"token":"0b0fb2392a6b81a5","endpoint":"c-lax08-9f1a554d.discord.media:443","sessionId":"59cf087a32eb839751a28783824b7ffe"}}
        2025-11-01T23:24:25.664Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Sent {"op":"playerUpdate","state":{"time":1762039465662,"position":0,"connected":true,"ping":0},"guildId":"1257685068927733902"}
        2025-11-01T23:24:50.438Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Sent {"op":"stats","frameStats":null,"players":1,"playingPlayers":0,"uptime":227368,"memory":{"free":214138232,"used":71074440,"allocated":285212672,"reservable":32178700288},"cpu":{"cores":48,"systemLoad":0.338068519659672,"lavalinkLoad":3.0208333333333335E-4}}
        2025-11-01T23:25:25.274Z  INFO 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketServer          : Connection closed from /100.64.0.2:16852 with id 5blxuy3b6m7u23n8 -- CloseStatus[code=1006, reason=]
        2025-11-01T23:25:25.274Z  INFO 1 --- [Lavalink] [  XNIO-1 I/O-41] lavalink.server.io.SocketContext         : Shutting down 0 playing players.
        2025-11-01T23:25:57.164Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.HandshakeInterceptorImpl     : Incoming connection from /100.64.0.5:37318
        2025-11-01T23:25:57.166Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/websocket
        2025-11-01T23:25:57.168Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] lavalink.server.io.SocketServer          : Connection successfully established from rainlink/[object Object] (https://github.com/RainyXeon/Rainlink)
        2025-11-01T23:25:57.168Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-32] lavalink.server.io.SocketContext         : Sent {"op":"ready","resumed":false,"sessionId":"krrcylsylrhzp63j"}
        2025-11-01T23:25:57.169Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-32] lavalink.server.io.SocketContext         : Sent {"op":"stats","frameStats":null,"players":0,"playingPlayers":0,"uptime":294100,"memory":{"free":212392624,"used":72820048,"allocated":285212672,"reservable":32178700288},"cpu":{"cores":48,"systemLoad":0.340117607036983,"lavalinkLoad":1.4048732242402445E-4}}
        com.sedmelluq.discord.lavaplayer.tools.FriendlyException: Something went wrong while looking up the track.
          at lavalink.server.util.LoadingKt.loadAudioItem(loading.kt:20) ~[classes!/:4.1.1]
          at lavalink.server.player.AudioLoaderRestHandler.loadTracks(AudioLoaderRestHandler.kt:59) ~[classes!/:4.1.1]
          at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke0(Native Method) ~[na:na]
        2025-11-01T23:26:16.400Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/stats
        2025-11-01T23:26:16.609Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : PATCH /v4/sessions/krrcylsylrhzp63j/players/1257685068927733902?noReplace=false, payload={"voice":{"token":"0b0fb2392a6b81a5","endpoint":"c-lax08-9f1a554d.discord.media:443","sessionId":"afd874ba562d58d74b488e0ca4a41570"}}
        2025-11-01T23:26:16.665Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-32] lavalink.server.io.SocketContext         : Sent {"op":"playerUpdate","state":{"time":1762039576664,"position":0,"connected":true,"ping":0},"guildId":"1257685068927733902"}
        2025-11-01T23:26:16.918Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/stats
        2025-11-01T23:26:16.926Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.player.AudioLoaderRestHandler   : Got request to load for identifier "https://open.spotify.com/track/2aL4lMGhWdPpyPL6COPou7?si=45e9bb44a5fa4bec"
        2025-11-01T23:26:17.064Z ERROR 1 --- [Lavalink] [  XNIO-1 task-2] l.server.player.AudioLoaderRestHandler   : Failed to load track for identifier https://open.spotify.com/track/2aL4lMGhWdPpyPL6COPou7?si=45e9bb44a5fa4bec
          at java.base/jdk.internal.reflect.NativeMethodAccessorImpl.invoke(Unknown Source) ~[na:na]
          at java.base/jdk.internal.reflect.DelegatingMethodAccessorImpl.invoke(Unknown Source) ~[na:na]
          at java.base/java.lang.reflect.Method.invoke(Unknown Source) ~[na:na]
          at kotlin.reflect.jvm.internal.calls.CallerImpl$Method.callMethod(CallerImpl.kt:97) ~[kotlin-reflect-2.1.20.jar!/:2.1.20-release-217]
        ...
        Caused by: com.sedmelluq.discord.lavaplayer.tools.FriendlyException: Unknown file format.
          ...
          at lavalink.server.util.LoadingKt.loadAudioItem(loading.kt:15) ~[classes!/:4.1.1]
          ... 67 common frames omitted
        2025-11-01T23:26:17.068Z  INFO 1 --- [Lavalink] [  XNIO-1 task-2] l.server.io.RequestLoggingFilter         : GET /v4/loadtracks?identifier=https%3A%2F%2Fopen.spotify.com%2Ftrack%2F2aL4lMGhWdPpyPL6COPou7%3Fsi%3D45e9bb44a5fa4bec
        2025-11-01T23:26:57.170Z TRACE 1 --- [Lavalink] [  XNIO-1 I/O-32] lavalink.server.io.SocketContext         : Sent {"op":"stats","frameStats":null,"players":1,"playingPlayers":0,"uptime":354100,"memory":{"free":204262128,"used":80950544,"allocated":285212672,"reservable":32178700288},"cpu":{"cores":48,"systemLoad":0.3468839760710095,"lavalinkLoad":1.9444444444444446E-4}}          console.warn(`[Rainlink]   4. Authentication failure (check password)`);
        }
...
bot.on('messageCreate', async (message) => {
  ...
  if (command === 'play' || command === 'p') {
    ...
    // Check if it's a Spotify URL and resolve it to a YouTube search query
